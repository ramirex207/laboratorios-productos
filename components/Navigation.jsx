...
function Navigation({ onClick }) {
    ...
    return (
        <ul className=" bg-teal-800 lg:bg-transparent rounded-xl lg:flex lg:flex-row-reverse flex flex-col justify-center lg:mt-4 pb-6 z-10" onClick={onClick}>
            ...
            <button
                            onClick={() => signOut()}
                            className='text-oliva-900 lg:text-lg lg:mr-4 lg:bg-red-500 bg-teal-900 w-11/12 lg:w-20 hover:bg-teal-400 p-2 m-8 lg:m-2 rounded-md self-center flex items-center justify-center mx-auto' // Agregamos "mx-auto" aquí
                        >
                            Salir
                        </button>
